...
| Field          | Value                |
| -------------- | -------------------- | -------- |
| Name           | [Your name or alias] | bing     |
| Age            | [Age]                | 31       |
| Height         | [cm]                 | 171      |
| Current Weight | [kg]                 | 87       |
| Target Weight  | [kg]                 | 70       |
| Location       | [City, Country]      | hangzhou |
...
| Type      | Description                             |
| --------- | --------------------------------------- | ------------------------------- |
| Primary   | [e.g., Cycling performance (Endurance)] | Cycling performance (Endurance) |
...
**Current Phase:** [e.g., Aerobic build + threshold development] build + threshold development
**Training Style:** [e.g., High-volume polarized (~15h/week)](6~10h/week)
...
**Baseline:** [X] hours/week (± [Y] hours) 6hours
...
| --------------------- | ------- | ------------------------------ | --- |
| FTP (Outdoor)         | [W]     |                                | 153 |
| FTP (Indoor)          | [W]     | Adjusted for indoor conditions | 150 |
